...
class TaskUpdate(BaseModel):
    ...
    @field_validator("depth")
    @classmethod
    def validate_depth(cls, v: Optional[int]) -> Optional[int]:
...
class Task(TaskBase):
    ...
    def set_timestamps(cls, values: Any) -> Any:
        """Set timestamps based on task status changes."""
    ...
    def validate_parent_not_self(self) -> None:
        """
    ...
    def validate_no_circular_dependencies(self, all_tasks: List["Task"]) -> None:
        """
