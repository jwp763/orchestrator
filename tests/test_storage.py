...
import pytest
from unittest.mock import Mock, patch as mock_patch, MagicMock
...
from src.models.schemas import (
    Project, Task, Patch, ProjectPatch, TaskPatch,
    ProjectStatus, TaskStatus, Priority, Op
)
...
class TestSQLStorageUnit:
    ...
    def test_get_project_calls_session_query(self, storage, mock_session):
    ...
    def test_update_project_calls_session_methods(self, storage, mock_session):
    ...
    def test_delete_project_calls_session_delete(self, storage, mock_session):
    ...
    def test_apply_project_patch_create_operation(self, storage):
    ...
    def test_apply_project_patch_update_operation(self, storage):
    ...
    def test_apply_project_patch_delete_operation(self, storage):
    ...
    def test_apply_task_patch_create_operation(self, storage):
    ...
    def test_apply_task_patch_update_operation(self, storage):
    ...
    def test_apply_task_patch_delete_operation(self, storage):
...
class TestSQLStorageIntegration:
    ...
    def test_project_lifecycle_full_crud(self, storage):
    ...
    def test_task_lifecycle_full_crud(self, storage):
    ...
    def test_get_tasks_by_project(self, storage):
    ...
    def test_apply_patch_success_with_rollback_on_failure(self, storage):
    ...
    def test_transaction_rollback_on_patch_failure(self, storage):
        ...
        mixed_patch = Patch(
            project_patches=[
                ProjectPatch(op=Op.CREATE, name="Valid Project")
            ],
            task_patches=[
    ...
    def test_project_task_relationship(self, storage):
